...
func (c *databaseServiceClient) Set(ctx context.Context, in *KeyValType, opts ...grpc.CallOption) (*ResultType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResultType)
	err := c.cc.Invoke(ctx, DatabaseService_Set_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseServiceClient) Delete(ctx context.Context, in *KeyType, opts ...grpc.CallOption) (*ResultType, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResultType)
...
func _DatabaseService_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DatabaseService_Set_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseServiceServer).Set(ctx, req.(*KeyValType))
	}
...
func _DatabaseService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseServiceServer).Get(ctx, req.(*KeyType))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DatabaseService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseServiceServer).Delete(ctx, req.(*KeyType))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DatabaseService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "codesourcerer_bot.database.DatabaseService",
